        ...
        <div class="p-3">
                ...
                <div id="layout-boxed">
                  <div class="form-check form-switch card-switch mb-1">
                    ...
                    <label class="form-check-label" for="layout-mode-boxed">
                      <img
                        src="/assets/images/layouts/boxed.png"
                        alt=""
                        class="img-fluid"
                      />
                    </label>
            ...
            <div class="col-4">
              <div class="form-check form-switch card-switch mb-1">
                ...
                <label class="form-check-label" for="topbar-color-dark">
                  <img
                    src="/assets/images/layouts/topbar-dark.png"
                    alt=""
                    class="img-fluid"
                  />
                </label>
              ...
              <div class="col-4">
                <div class="form-check form-switch card-switch mb-1">
                  ...
                  <label class="form-check-label" for="leftbar-color-light">
                    <img
                      src="/assets/images/layouts/sidebar-light.png"
                      alt=""
                      class="img-fluid"
                    />
                  </label>
              ...
              <div class="col-4">
                <div class="form-check form-switch card-switch mb-1">
                  ...
                  <label class="form-check-label" for="leftbar-size-compact">
                    <img
                      src="/assets/images/layouts/compact.png"
                      alt=""
                      class="img-fluid"
                    />
                  </label>
              ...
              <div class="col-4">
                <div class="form-check form-switch card-switch mb-1">
                  ...
                  <label class="form-check-label" for="leftbar-size-small">
                    <img
                      src="/assets/images/layouts/sm.png"
                      alt=""
                      class="img-fluid"
                    />
                  </label>
              ...
              <div class="col-4">
                <div class="form-check form-switch card-switch mb-1">
                  ...
                  <label class="form-check-label" for="leftbar-size-full">
                    <img
                      src="/assets/images/layouts/full.png"
                      alt=""
                      class="img-fluid"
                    />
                  </label>
          ...
          <div id="layout-position">
            ...
            <div class="btn-group checkbox" role="group">
              ...
              />
              <label
                class="btn btn-soft-primary w-sm"
