<template>
    <div class="container mt-4">
      <div class="card shadow-lg">
        ...
        <!-- Search Bar -->
        <div class="mb-3 mt-3">
          <form class="d-flex justify-content-center" @submit.prevent="fetchsales">
            <div class="input-group" style="max-width: 400px">
              <input v-model="search" @input="fetchsales" class="form-control rounded" placeholder="Search..." />
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                ...
                <tr v-if="sales.data && sales.data.length === 0">
                  <td colspan="6" class="text-center text-danger">No sales Found</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div v-if="pagination.links" class="d-flex justify-content-center mt-3">
            <nav>
              <ul class="pagination pagination-sm">
                ...
                >
                  <a href="#" class="page-link" v-html="formatPageLabel(page.label)" @click.prevent="page.url && fetchsales(page.url)">
                  </a>
                </li>
              </ul>
            </nav>
  ...
  const search = ref(""); // empty string হওয়া উচিত
  ...
  <style>
  /* নিজের ইচ্ছামত স্টাইল দিতে পারো */
  </style>
