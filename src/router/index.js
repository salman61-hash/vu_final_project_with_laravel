...
import CreateExpense_type from "@/pages/expense_type/CreateExpense_type.vue";
import ManageExpense_type from "@/pages/expense_type/ManageExpense_type.vue";
...
import ManageProfit from "@/pages/profit/ManageProfit.vue";
...
import ManageStock from "@/pages/stock/ManageStock.vue";
...
const routes = [
...

  {
    ...
    children: [
      ...
      // expense_type
      { path: "expense_type", component: ManageExpense_type },
      { path: "create_expense_type", component: CreateExpense_type },
      ...
      // stock
      { path: "stock", component: ManageStock },
